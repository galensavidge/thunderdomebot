...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game(type=discord.ActivityType.custom, name="Skynet online", state="Awaiting commands", details="tdb!help", url="https://github.com/galensavidge/thunderdomebot"), status=discord.Status.online)
